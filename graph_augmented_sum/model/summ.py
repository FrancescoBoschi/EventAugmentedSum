...
from graph_augmented_sum.utils import END
...
class Seq2SeqSumm(nn.Module):
    def __init__(self, vocab_size, emb_dim,
        ...
        # We use nn.Parameter rather than nn.Linear so that we can initialize
        # the weights as we prefer, and it' shown below how we do it
